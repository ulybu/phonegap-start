...
enyo.path.addPaths({layout: "C://Users/ulybu/Enyo/withMarkus/bootplate/enyo/../lib/layout/", onyx: "C://Users/ulybu/Enyo/withMarkus/bootplate/enyo/../lib/onyx/", onyx: "C://Users/ulybu/Enyo/withMarkus/bootplate/enyo/../lib/onyx/source/"});
...
tweetSelected: function(e, t) {
enyo.log("handler");
var n = t.tweet;
this.$.tweetlist.setTweet(n), enyo.Panels.isScreenNarrow() && this.next();
},
goBack: function(e, t) {
this.setIndex(0);
}
...
e.response(this, "processResults"), e.go({
q: this.$.seach12.getValue(),
rpp: 100
});
},
processResults: function(e, t) {
enyo.log(t.results), this.tweets = t.results, this.$.liist.setCount(this.tweets.length), this.$.liist.refresh();
},
setupItem: function(e, t) {
var n = this.tweets[t.index];
this.$.item.setContent(n.from_user + "  =>  " + n.text), this.$.item.addRemoveClass("selected-tweet", e.isSelected(t.index));
},
tweetTapped: function(e, t) {
this.doTweetSelected({
tweet: this.tweets[t.index]
});
}
});
...
create: function() {
this.inherited(arguments), this.tweetChanged();
},
resized: function() {
this.inherited(arguments), enyo.Panels.isScreenNarrow() ? this.$.backbutton.setShowing(!0) : this.$.backbutton.setShowing(!1);
},
tweetChanged: function(e) {
enyo.log(this.tweet), this.$.name.setContent(this.tweet.from_user_name), this.$.text.setContent(this.tweet.text), this.$.image.setSrc(this.tweet.profile_image_url), this.$.date.setContent(this.tweet.created_at);
},
goback: function(e, t) {
this.doBack();
}
